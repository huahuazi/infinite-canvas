...
/** 线程摘要。 */
export type ThreadBrief = { id: string; preview?: string; name?: string | null; cwd?: string; status?: string; updatedAt?: number };
...
export type TurnOptions = {
    ...
    onFinish?: () => void;
    onDelta?: (delta: { type: string; text?: string; itemId?: string }) => void;
};
...
export interface AgentAdapter {
    ...
    /** 列出线程。 */
    listThreads(opts: { cwd: string; searchTerm?: string; limit?: number }): Promise<{ data: ThreadBrief[] }>;
    ...
    /** 可用模型列表。 */
    listModels(): Promise<Array<{ id: string; displayName?: string; defaultReasoningEffort?: string }>>;
