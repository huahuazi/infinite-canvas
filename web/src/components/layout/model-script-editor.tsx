            ...
            <div className="flex h-[60vh] min-h-[420px] border-t border-stone-200 dark:border-stone-800">
                ...
                <div className="min-w-0 flex-1 overflow-hidden bg-white dark:bg-stone-950">
                    <textarea
                        ...
                        className="h-full w-full resize-none bg-transparent p-4 font-mono text-[13px] leading-6 text-stone-800 outline-none placeholder:text-stone-400 dark:text-stone-100"
                    />
                </div>
            </div>
        </Modal>
